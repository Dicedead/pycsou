...
def bunny_high():
    return 1 * iio.imread("pyxu/experimental/xray/pngs/bunny_zres_100_reweighted__088.png")


def bunny_middle1():
    return 1 * iio.imread("pyxu/experimental/xray/pngs/bunny_zres_100_reweighted__056.png")


def bunny_middle2():
    return 1 * iio.imread("pyxu/experimental/xray/pngs/bunny_zres_100_reweighted__033.png")


def bunny_low():
    return 1 * iio.imread("pyxu/experimental/xray/pngs/bunny_zres_100_reweighted__009.png")
...
if __name__ == "__main__":
    ...
    # plot_four_images(
    #     [bunny_high(), lcav_low_img, lcav_middle1_img, lcav_high_img],
    #     ["Ground truth", "Low", "Middle", "High"],
    #     "No thresholding",
    #     "no_thresholding.png"
    # )
